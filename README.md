...
| [Tandur Admin](https://github.com/zhiganik/tandur_admin) | Admin panel front-end for Tandur — management dashboards consuming the backend's REST API | Next.js 14, TypeScript, Ant Design, TanStack Query, Zustand |
